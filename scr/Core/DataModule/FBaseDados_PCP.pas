...
type
   TBaseDados_PCP = class(TDataModule)
    ...
    db_qualidades: TFDQuery;
      ...
      db_turnosGradeTURNO1_HORA_INI: TBCDField;
      db_turnosGradeTURNO1_HORA_FIM: TBCDField;
      db_turnosGradeTURNO2_HORA_INI: TBCDField;
      db_turnosGradeTURNO2_HORA_FIM: TBCDField;
      ...
      db_VincMaquinasDetalhesTEMPO: TBCDField;
    ...
    db_OrdemProducaoTEMPO_PRODUCAO: TBCDField;
    ...
    db_pcp_processosTEMPO: TBCDField;
